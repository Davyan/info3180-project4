...
wishListApp.controller('WishListController' , ['$scope' , '$cookies' , '$http' , '$location', '$log', '$rootScope' ,
        function($scope , $cookies, $http, $location, $log, $rootScope){
            ...
            $scope.sendEmail = function(){
                $http.post('/share/'+$cookies.get('currentUserId'),{title: $scope.title, thumbnailUrl: $scope.imageUrl, email: $scope.email, message: $scope.message, itemUrl: $scope.itemUrl}, {}).
                   success(function(data, status){
                       $log.log(JSON.stringify(data));
                   }).
                error(function(error, status){
...
wishListApp.controller('ItemController' , ['$scope' , '$cookies', '$location','$http','$log','$rootScope',
        function($scope , $cookies, $location, $http, $log,$rootScope){
            ...
            $scope.sendEmail = function(){
                $http.post('/shareitem/'+$cookies.get('currentUserId'),{thumbnailUrl: $scope.thumbnailUrl, title: $scope.title, imageUrl: $scope.imageUrl, email: $scope.email, message: $scope.message, itemUrl: $scope.itemUrl}, {}).
                   success(function(data, status){
                       $log.log(JSON.stringify(data));
                   }).
                error(function(error, status){
